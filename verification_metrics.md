...
Ran in 6.3s under python 3.11.15, numpy 2.2.6, torch 2.6.0+cu124.
...
with `set_trunk_trainable` neutered: died
  freeze violated: trunk moved by 6.027e-04 (expected exactly 0) or the head did not move (6.025e-03). The schedule did no
